    ...
    render(){
        if(this.state.IsBookRequestActive === true){
            return(
                <View style={{flex:1,justifyContent:'center'}}>
                    ...
                    <TouchableOpacity style={{borderWidth:1,bordeColor:'orange',backgroundColor:'orange',width:300,alignSelf:'center'}}
                        onPress={()=>{
        ...
        return(
            <View styles = {{flex: 1}}>
                ...
                <ScrollView>
                <KeyboardAvoidingView styles = {styles.keyboardStyle}>
